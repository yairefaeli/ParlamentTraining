(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('geodesy'), require('util'), require('primitive-primitives'), require('json-string-mapper'), require('angular2parse'), require('lodash.get'), require('heatmap.js/build/heatmap.js'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-cesium', ['exports', 'geodesy', 'util', 'primitive-primitives', 'json-string-mapper', 'angular2parse', 'lodash.get', 'heatmap.js/build/heatmap.js', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['angular-cesium'] = {}),global.geodesy,global.util,global.primitivePrimitives,global.jsonStringMapper,global.angular2parse,global._get,global.h337,global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,geodesy,util,primitivePrimitives,jsonStringMapper,angular2parse,_get,h337,common,rxjs,operators,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CesiumService = /** @class */ (function () {
        ...
        /** @nocollapse */
        CesiumService.ctorParameters = function () {
            return [
                { type: core.NgZone },
                { type: ViewerFactory },
    ...
    var CoordinateConverter = /** @class */ (function () {
        ...
        /** @nocollapse */
        CoordinateConverter.ctorParameters = function () {
            return [
    ...
    var GeoUtilsService = /** @class */ (function () {
        ...
        /** @nocollapse */
        GeoUtilsService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var ArcDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        ArcDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var OptimizedEntityCollection = /** @class */ (function () {
        function OptimizedEntityCollection(entityCollection, collectionSize, updateRate) {
            if (collectionSize === void 0) {
                collectionSize = -1;
            }
            if (updateRate === void 0) {
                updateRate = -1;
            }
    ...
    var BillboardDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        BillboardDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var CzmlDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        CzmlDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var EllipseDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        EllipseDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var LabelDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        LabelDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PointDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PointDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PolygonDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PolygonDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PolylineDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PolylineDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PolylinePrimitiveDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PolylinePrimitiveDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var KeyboardControlService = /** @class */ (function () {
         ...
         */
            function (definitions, keyMappingFn, outsideOfAngularZone) {
                var _this = this;
                if (outsideOfAngularZone === void 0) {
        ...
        /** @nocollapse */
        KeyboardControlService.ctorParameters = function () {
            return [
                { type: core.NgZone },
                { type: CesiumService },
    ...
    var CesiumPureEventObserver = /** @class */ (function () {
         ...
         */
            function (eventsHandler) {
                var _this = this;
                this.observer = rxjs.Observable.create(function (observer) {
    ...
    var CesiumEventBuilder = /** @class */ (function () {
         ...
         */
            function (event, modifier) {
                ...
                if (CesiumEventBuilder.longPressEvents.has(event)) {
                    ...
                    cesiumEventObservable = operators.publish()(new CesiumPureEventObserver(event, modifier).init(this.eventsHandler));
                }
        ...
        /** @nocollapse */
        CesiumEventBuilder.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PlonterService = /** @class */ (function () {
        function PlonterService() {
            ...
            this._plonterChangeNotifier = new core.EventEmitter();
            this._plonterObserver = new rxjs.Subject();
        }
    ...
    var MapEventsManagerService = /** @class */ (function () {
         ...
         */
            function (event, modifier, entityType, pickOption, priority, pickFilter) {
                ...
                /** @type {?} */
                var stopper = new rxjs.Subject();
                /** @type {?} */
                var registration = new Registration(undefined, stopper, priority, false);
                /** @type {?} */
                var observable;
                if (!CesiumDragDropHelper.dragEvents.has(event)) {
                    observable = cesiumEventObservable.pipe(operators.filter(function () { return !registration.isPaused; }), operators.map(function (movement) { return _this.triggerPick(movement, pickOption); }), operators.filter(function (result) { return result.cesiumEntities !== null || entityType === undefined; }), operators.map(function (picksAndMovement) { return _this.addEntities(picksAndMovement, entityType, pickOption, pickFilter); }), operators.filter(function (result) { return result.entities !== null || (entityType === undefined && !pickFilter); }), operators.switchMap(function (entitiesAndMovement) { return _this.plonter(entitiesAndMovement, pickOption); }), operators.takeUntil(stopper));
                }
                else {
                    observable = this.createDragEvent(event, modifier, entityType, pickOption, priority, pickFilter).pipe(operators.takeUntil(stopper));
                }
         ...
         */
            function (event, modifier, entityType, pickOption, priority, pickFilter) {
                ...
                /** @type {?} */
                var dropSubject = new rxjs.Subject();
                /** @type {?} */
                var dragObserver = mouseDownRegistration.observable.pipe(operators.mergeMap(function (e) {
                    /** @type {?} */
                    var lastMove = null;
                    /** @type {?} */
                    ...
                    return mouseMoveObservable.pipe(operators.map(function (movement) {
                        lastMove = {
                            movement: {
                                drop: false,
                                startPosition: {
                        ...
                        return lastMove;
                    }), operators.takeUntil(mouseUpObservable), operators.tap(undefined, undefined, function () {
                        // On complete
                        if (lastMove) {
                            /** @type {?} */
                ...
                return rxjs.merge(dragObserver, dropSubject);
            };
        /**
         * @private
         * @param {?} movement
        ...
        /** @nocollapse */
        MapEventsManagerService.ctorParameters = function () {
            return [
                { type: CesiumService },
    ...
    var MapLayersService = /** @class */ (function () {
        ...
        /** @nocollapse */
        MapLayersService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var ScreenshotService = /** @class */ (function () {
        ...
        /** @nocollapse */
        ScreenshotService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var AcMapComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcMapComponent.ctorParameters = function () {
            return [
                { type: CesiumService },
                { type: CameraService },
    ...
    var LayerService = /** @class */ (function () {
        function LayerService() {
            this._cache = true;
            this.descriptions = [];
            this.layerUpdate = new core.EventEmitter();
        }
    ...
    var DynamicEllipseDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        DynamicEllipseDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var DynamicPolylineDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        DynamicPolylineDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var StaticCircleDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        StaticCircleDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var StaticPolylineDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        StaticPolylineDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var StaticPolygonDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        StaticPolygonDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var StaticEllipseDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        StaticEllipseDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var ModelDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        ModelDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var BoxDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        BoxDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var CorridorDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        CorridorDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var CylinderDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        CylinderDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var EllipsoidDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        EllipsoidDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PolylineVolumeDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PolylineVolumeDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var WallDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        WallDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var RectangleDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        RectangleDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var LabelPrimitiveDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        LabelPrimitiveDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var BillboardPrimitiveDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        BillboardPrimitiveDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var PointPrimitiveDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        PointPrimitiveDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var HtmlDrawerService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        HtmlDrawerService.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var AcLayerComponent = /** @class */ (function () {
        function AcLayerComponent(layerService, _computationCache, mapLayersService, billboardDrawerService, labelDrawerService, ellipseDrawerService, polylineDrawerService, polygonDrawerService, arcDrawerService, pointDrawerService, modelDrawerService, boxDrawerService, corridorDrawerService, cylinderDrawerService, ellipsoidDrawerSerice, polylineVolumeDrawerService, wallDrawerService, rectangleDrawerService, dynamicEllipseDrawerService, dynamicPolylineDrawerService, staticCircleDrawerService, staticPolylineDrawerService, staticPolygonDrawerService, staticEllipseDrawerService, polylinePrimitiveDrawerService, labelPrimitiveDrawerService, billboardPrimitiveDrawerService, pointPrimitiveDrawerService, htmlDrawerService, czmlDrawerService) {
            ...
            this.stopObservable = new rxjs.Subject();
            this._updateStream = new rxjs.Subject();
         ...
         */
            function () {
                ...
                rxjs.merge(this._updateStream, this.observable).pipe(operators.takeUntil(this.stopObservable)).subscribe(function (notification) {
        ...
        /** @nocollapse */
        AcLayerComponent.ctorParameters = function () {
            return [
                { type: LayerService },
    ...
    var AcBillboardComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcBillboardComponent.ctorParameters = function () {
            return [
                { type: BillboardDrawerService },
                { type: MapLayersService }
            ];
    ...
    var BasicDesc = /** @class */ (function () {
        function BasicDesc(_drawer, _layerService, _computationCache, _cesiumProperties) {
            ...
            this.onDraw = new core.EventEmitter();
    ...
    var CesiumProperties = /** @class */ (function () {
         ...
         */
            function (expression, withCache) {
                ...
                resultMap.forEach(function (resultExpression, prop) {
                    return propsMap.set(prop, {
        ...
        /** @nocollapse */
        CesiumProperties.ctorParameters = function () {
            return [
    ...
    var AcBillboardDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcBillboardDescComponent.ctorParameters = function () {
            return [
                { type: BillboardDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcEllipseDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcEllipseDescComponent.ctorParameters = function () {
            return [
                { type: EllipseDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcPolylineDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolylineDescComponent.ctorParameters = function () {
            return [
                { type: PolylineDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcLabelDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcLabelDescComponent.ctorParameters = function () {
            return [
                { type: LabelDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcCircleDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcCircleDescComponent.ctorParameters = function () {
            return [
                { type: EllipseDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcArcDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcArcDescComponent.ctorParameters = function () {
            return [
                { type: ArcDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcMapLayerProviderComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcMapLayerProviderComponent.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var AcPointDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPointDescComponent.ctorParameters = function () {
            return [
                { type: PointDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcLabelComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcLabelComponent.ctorParameters = function () {
            return [
                { type: LabelDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcPolylineComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolylineComponent.ctorParameters = function () {
            return [
                { type: PolylineDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcEllipseComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcEllipseComponent.ctorParameters = function () {
            return [
                { type: EllipseDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcPointComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPointComponent.ctorParameters = function () {
            return [
                { type: PointDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcHtmlComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcHtmlComponent.ctorParameters = function () {
            return [
                { type: CesiumService },
                { type: core.ElementRef },
                { type: core.Renderer2 }
    ...
    var AcCircleComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcCircleComponent.ctorParameters = function () {
            return [
                { type: EllipseDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcArcComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcArcComponent.ctorParameters = function () {
            return [
                { type: ArcDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcPolygonDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolygonDescComponent.ctorParameters = function () {
            return [
                { type: PolygonDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcDefaultPlonterComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcDefaultPlonterComponent.ctorParameters = function () {
            return [
                { type: PlonterService },
    ...
    var AcPolygonComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolygonComponent.ctorParameters = function () {
            return [
                { type: PolygonDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcStaticEllipseDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcStaticEllipseDescComponent.ctorParameters = function () {
            return [
                { type: StaticEllipseDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcDynamicEllipseDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcDynamicEllipseDescComponent.ctorParameters = function () {
            return [
                { type: DynamicEllipseDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcDynamicPolylineDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcDynamicPolylineDescComponent.ctorParameters = function () {
            return [
                { type: DynamicPolylineDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcStaticPolygonDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcStaticPolygonDescComponent.ctorParameters = function () {
            return [
                { type: StaticPolygonDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcStaticCircleDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcStaticCircleDescComponent.ctorParameters = function () {
            return [
                { type: StaticCircleDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcDynamicCircleDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcDynamicCircleDescComponent.ctorParameters = function () {
            return [
                { type: DynamicEllipseDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcStaticPolylineDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcStaticPolylineDescComponent.ctorParameters = function () {
            return [
                { type: StaticPolylineDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcModelDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcModelDescComponent.ctorParameters = function () {
            return [
                { type: ModelDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcTileset3dComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcTileset3dComponent.ctorParameters = function () {
            return [
                { type: CesiumService }
            ];
        };
    ...
    var AcBoxDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcBoxDescComponent.ctorParameters = function () {
            return [
                { type: BoxDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcCylinderDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcCylinderDescComponent.ctorParameters = function () {
            return [
                { type: CylinderDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcCorridorDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcCorridorDescComponent.ctorParameters = function () {
            return [
                { type: CorridorDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcEllipsoidDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcEllipsoidDescComponent.ctorParameters = function () {
            return [
                { type: EllipsoidDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcPolylineVolumeDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolylineVolumeDescComponent.ctorParameters = function () {
            return [
                { type: PolylineVolumeDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcWallDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcWallDescComponent.ctorParameters = function () {
            return [
                { type: WallDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcRectangleDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcRectangleDescComponent.ctorParameters = function () {
            return [
                { type: RectangleDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcBillboardPrimitiveDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcBillboardPrimitiveDescComponent.ctorParameters = function () {
            return [
                { type: BillboardPrimitiveDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcLabelPrimitiveDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcLabelPrimitiveDescComponent.ctorParameters = function () {
            return [
                { type: LabelPrimitiveDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcPolylinePrimitiveDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPolylinePrimitiveDescComponent.ctorParameters = function () {
            return [
                { type: PolylinePrimitiveDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcHtmlDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcHtmlDirective.ctorParameters = function () {
            return [
    ...
    var AcHtmlDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcHtmlDescComponent.ctorParameters = function () {
            return [
                { type: HtmlDrawerService },
                { type: LayerService },
                { type: ComputationCache },
        ...
        AcHtmlDescComponent.propDecorators = {
            acHtmlCreator: [{ type: core.ViewChild, args: [AcHtmlDirective,] }],
            acHtmlTemplate: [{ type: core.ContentChild, args: [core.TemplateRef,] }]
        };
    ...
    var AcHtmlContainerDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcHtmlContainerDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: AcHtmlManager }
            ];
    ...
    var AcContextMenuWrapperComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcContextMenuWrapperComponent.ctorParameters = function () {
            return [
                { type: ContextMenuService },
                { type: core.ChangeDetectorRef },
    ...
    var AcArrayDescComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AcArrayDescComponent.ctorParameters = function () {
            return [
                { type: LayerService },
                { type: core.ChangeDetectorRef }
            ];
        ...
        AcArrayDescComponent.propDecorators = {
            ...
            show: [{ type: core.Input }],
            layer: [{ type: core.ViewChild, args: ['layer',] }],
    ...
    var AcPointPrimitiveDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPointPrimitiveDescComponent.ctorParameters = function () {
            return [
                { type: PointPrimitiveDrawerService },
                { type: LayerService },
                { type: ComputationCache },
    ...
    var AcPrimitivePolylineComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcPrimitivePolylineComponent.ctorParameters = function () {
            return [
                { type: PolylinePrimitiveDrawerService },
                { type: MapLayersService }
            ];
    ...
    var AcCzmlDescComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AcCzmlDescComponent.ctorParameters = function () {
            return [
                { type: CzmlDrawerService },
                { type: LayerService },
                { type: ComputationCache },
            ...
            function (config) {
                return {
                    ...
                    providers: [
                        ...
                        { provide: angular2parse.PIPES_CONFIG, multi: true, useValue: config && config.customPipes || [] },
                        { provide: angular2parse.PIPES_CONFIG, multi: true, useValue: PARSE_PIPES_CONFIG_MAP },
                    ],
                };
            };
    ...
    var SelectionManagerService = /** @class */ (function () {
        function SelectionManagerService(mapsManager) {
            ...
            this.selectedEntitiesItems$ = new rxjs.BehaviorSubject([]);
            this.selectedEntitySubject$ = new rxjs.Subject();
        }
        /**
         * @return {?}
         */
         ...
         */
            function (selectionOptions, addSelectedIndicator, eventPriority, mapId) {
                var _this = this;
                if (addSelectedIndicator === void 0) {
                    addSelectedIndicator = true;
                }
                /** @type {?} */
                ...
                eventSubscription.pipe(operators.map(function (result) { return result.entities; }), operators.filter(function (entities) { return entities && entities.length > 0; }))
        ...
        /** @nocollapse */
        SelectionManagerService.ctorParameters = function () {
            return [
                { type: MapsManagerService }
            ];
        };
    ...
    var PolygonsEditorService = /** @class */ (function () {
        function PolygonsEditorService() {
            ...
            this.updatePublisher = operators.publish()(this.updateSubject); // TODO maybe not needed
         ...
         */
            function (options, priority) {
                var _this = this;
                if (options === void 0) {
                    options = DEFAULT_POLYGON_OPTIONS;
                }
                if (priority === void 0) {
                    priority = 100;
                }
                ...
                /** @type {?} */
                var clientEditSubject = new rxjs.BehaviorSubject({
                    id: id,
                    editAction: null,
         ...
         */
            function (positions, options, priority) {
                ...
                var polygonOptions = this.setOptions(options);
                /** @type {?} */
                var editSubject = new rxjs.BehaviorSubject({
                    id: id,
                    editAction: null,
    ...
    var PolygonsEditorComponent = /** @class */ (function () {
        function PolygonsEditorComponent(polygonsEditor, coordinateConverter, mapEventsManager, cameraService, polygonsManager) {
            ...
            this.polygonsManager = polygonsManager;
            this.Cesium = Cesium;
            this.editPoints$ = new rxjs.Subject();
            this.editPolylines$ = new rxjs.Subject();
            this.editPolygons$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        PolygonsEditorComponent.ctorParameters = function () {
            return [
    ...
    var EditableCircle = /** @class */ (function (_super) {
         ...
         */
            function (center, radiusPoint, centerPointProp, radiusPointProp, circleProp) {
                if (centerPointProp === void 0) {
                    centerPointProp = this.pointProps;
                }
                if (radiusPointProp === void 0) {
                    radiusPointProp = this.pointProps;
                }
                if (circleProp === void 0) {
    ...
    var CirclesEditorComponent = /** @class */ (function () {
        function CirclesEditorComponent(circlesEditor, coordinateConverter, mapEventsManager, cameraService, circlesManager) {
            ...
            this.Cesium = Cesium;
            this.editPoints$ = new rxjs.Subject();
            this.editCircles$ = new rxjs.Subject();
            this.editArcs$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        CirclesEditorComponent.ctorParameters = function () {
            return [
    ...
    var EllipsesEditorComponent = /** @class */ (function () {
        function EllipsesEditorComponent(ellipsesEditor, coordinateConverter, mapEventsManager, cameraService, ellipsesManager) {
            ...
            this.Cesium = Cesium;
            this.editPoints$ = new rxjs.Subject();
            this.editEllipses$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        EllipsesEditorComponent.ctorParameters = function () {
            return [
    ...
    var PolylinesEditorComponent = /** @class */ (function () {
        function PolylinesEditorComponent(polylinesEditor, coordinateConverter, mapEventsManager, cameraService, polylinesManager) {
            ...
            this.editPoints$ = new rxjs.Subject();
            this.editPolylines$ = new rxjs.Subject();
            this.polylineLabels$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        PolylinesEditorComponent.ctorParameters = function () {
            return [
    ...
    var HippodromeEditorService = /** @class */ (function () {
         ...
         */
            function (options, eventPriority) {
                var _this = this;
                if (options === void 0) {
                    options = DEFAULT_HIPPODROME_OPTIONS;
                }
                if (eventPriority === void 0) {
                    eventPriority = 100;
                }
    ...
    var HippodromeEditorComponent = /** @class */ (function () {
        function HippodromeEditorComponent(hippodromesEditor, coordinateConverter, mapEventsManager, cameraService, hippodromesManager) {
            ...
            this.Cesium = Cesium;
            this.editPoints$ = new rxjs.Subject();
            this.editHippodromes$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        HippodromeEditorComponent.ctorParameters = function () {
            return [
    ...
    var DraggableToMapService = /** @class */ (function () {
        function DraggableToMapService(document, mapsManager) {
            this.document = document;
            this.mapsManager = mapsManager;
            this.mainSubject = new rxjs.Subject();
        }
        /**
         * @param {?} coordinateConverter
         * @return {?}
         ...
         */
            function () {
                ...
                var dropSubject = new rxjs.Subject();
                /** @type {?} */
                var pointerUp = rxjs.fromEvent(document, 'pointerup');
                /** @type {?} */
                var pointerMove = rxjs.fromEvent(document, 'pointermove');
                /** @type {?} */
                ...
                var lastMove;
                /** @type {?} */
                var moveObservable = pointerMove.pipe(operators.map(function (e) {
                    ...
                    return lastMove;
                }), operators.takeUntil(pointerUp), operators.tap(undefined, undefined, function () {
                    if (lastMove) {
                        /** @type {?} */
                        var dropEvent = Object.assign({}, lastMove);
                        dropEvent.drop = true;
        ...
        /** @nocollapse */
        DraggableToMapService.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [common.DOCUMENT,] }] },
                { type: MapsManagerService }
            ];
    ...
    var DraggableToMapDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DraggableToMapDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
    ...
    var AcToolbarComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        AcToolbarComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
            function (changes) {
         ...
         * @return {?}
         */
        AcToolbarComponent.prototype.listenForDragging = /**
         * @private
         * @return {?}
         */
            function () {
                var _this = this;
                this.mouseDown$ = this.mouseDown$ || rxjs.fromEvent(this.element.nativeElement, 'mousedown');
                this.mouseMove$ = this.mouseMove$ || ( /** @type {?} */(rxjs.fromEvent(document, 'mousemove')));
                this.mouseUp$ = this.mouseUp$ || ( /** @type {?} */(rxjs.fromEvent(document, 'mouseup')));
                this.drag$ = this.drag$ ||
                    this.mouseDown$.pipe(operators.switchMap(function () { return _this.mouseMove$.pipe(operators.tap(_this.onDrag.emit), operators.takeUntil(_this.mouseUp$)); }));
        ...
        /** @nocollapse */
        AcToolbarComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: CesiumService }
            ];
    ...
    var RangeAndBearingComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        RangeAndBearingComponent.ctorParameters = function () {
            return [
                { type: PolylinesEditorService },
                { type: CoordinateConverter }
            ];
    ...
    var ZoomToRectangleService = /** @class */ (function () {
         ...
         * @return {?}
         */
            function (cameraService, positions, animationDuration, options) {
                /** @type {?} */
        ...
        /** @nocollapse */
        ZoomToRectangleService.ctorParameters = function () {
            return [
                { type: MapsManagerService },
    ...
    exports.MapLayerProviderOptions = MapLayerProviderOptions;
    ...
    exports.CesiumEventModifier = CesiumEventModifier;
    exports.CesiumEvent = CesiumEvent;
    ...
    exports.RadiansToDegreesPipe = RadiansToDegreesPipe;
    ...
    exports.EditableEllipse = EditableEllipse;
    exports.EditorObservable = EditorObservable;
    exports.PolylineEditorObservable = PolylineEditorObservable;
    exports.PolygonEditorObservable = PolygonEditorObservable;
    exports.CircleEditorObservable = CircleEditorObservable;
    exports.EllipseEditorObservable = EllipseEditorObservable;
    exports.defaultLabelProps = defaultLabelProps;
    exports.HippodromeEditorObservable = HippodromeEditorObservable;
    exports.EditableHippodrome = EditableHippodrome;
    ...
    exports.EllipsesEditorComponent = EllipsesEditorComponent;
    ...
    exports.RangeAndBearingComponent = RangeAndBearingComponent;
    ...
    exports.DEFAULT_ELLIPSE_OPTIONS = DEFAULT_ELLIPSE_OPTIONS;
    exports.EllipsesEditorService = EllipsesEditorService;
    exports.DraggableToMapService = DraggableToMapService;
    exports.MouseButtons = MouseButtons;
    exports.ZoomToRectangleService = ZoomToRectangleService;
    exports.ɵcg = DragIconComponent;
    exports.ɵcd = CirclesManagerService;
    exports.ɵce = EllipsesManagerService;
    exports.ɵcb = HippodromeManagerService;
    exports.ɵcc = PolygonsManagerService;
    exports.ɵcf = PolylinesManagerService;
    exports.ɵr = ANGULAR_CESIUM_CONFIG;
    exports.ɵs = ConfigurationService;
    exports.ɵbt = AcContextMenuWrapperComponent;
    exports.ɵbz = AcCzmlDescComponent;
    exports.ɵbs = AcModelDescComponent;
    exports.ɵbu = AcPointPrimitiveDescComponent;
    exports.ɵby = AcHtmlContainerDirective;
    exports.ɵbw = AcHtmlContext;
    exports.ɵbx = AcHtmlDirective;
    exports.ɵbv = AcHtmlManager;
    exports.ɵbp = BasicDesc;
    exports.ɵca = BasicStaticPrimitiveDesc;
    exports.ɵbq = CesiumProperties;
    exports.ɵu = ComputationCache;
    exports.ɵn = ArcDrawerService;
    exports.ɵe = BasicDrawerService;
    exports.ɵc = BillboardDrawerService;
    exports.ɵbe = BillboardPrimitiveDrawerService;
    exports.ɵw = BoxDrawerService;
    exports.ɵx = CorridorDrawerService;
    exports.ɵy = CylinderDrawerService;
    exports.ɵo = CzmlDrawerService;
    exports.ɵz = EllipsoidDrawerService;
    exports.ɵl = EllipseDrawerService;
    exports.ɵd = EntitiesDrawerService;
    exports.ɵf = GraphicsType;
    exports.ɵbg = HtmlDrawerService;
    exports.ɵh = LabelDrawerService;
    exports.ɵbd = LabelPrimitiveDrawerService;
    exports.ɵv = ModelDrawerService;
    exports.ɵm = PointDrawerService;
    exports.ɵbf = PointPrimitiveDrawerService;
    exports.ɵp = PolygonDrawerService;
    exports.ɵi = PolylineDrawerService;
    exports.ɵj = PolylinePrimitiveDrawerService;
    exports.ɵba = PolylineVolumeDrawerService;
    exports.ɵk = PrimitivesDrawerService;
    exports.ɵbc = RectangleDrawerService;
    exports.ɵbi = DynamicPolylineDrawerService;
    exports.ɵbh = DynamicEllipseDrawerService;
    exports.ɵbn = StaticEllipseDrawerService;
    exports.ɵbj = StaticCircleDrawerService;
    exports.ɵbm = StaticPolygonDrawerService;
    exports.ɵbl = StaticPolylineDrawerService;
    exports.ɵbk = StaticPrimitiveDrawer;
    exports.ɵbb = WallDrawerService;
    exports.ɵbo = EntityOnMapComponent;
    exports.ɵbr = JsonMapper;
    exports.ɵt = LayerService;
    exports.ɵg = CesiumEventBuilder;
    exports.ɵq = MapLayersService;
    exports.ɵb = ViewerFactory;
    exports.ɵa = UtilsModule;
